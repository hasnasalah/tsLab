...
const newPhysicalProduct = new PhysicalProduct("T-shirt", "T14OS45", 10.99, 0.5, 6);
...
const thirdPhysicalProduct = new PhysicalProduct("boots", "B14OS45", 116.99, 3, 10);
const thirdDigitalProduct = new DigitalProduct("Fitness Tracker App", "FTA147B", 49.79, 30);
const products = [newPhysicalProduct, newDigitalProduct, secondPhysicalProduct, secondDigitalProduct, thirdDigitalProduct, thirdPhysicalProduct];
